              ...
              <div className="grid grid-cols-2 gap-4 md:gap-6">
                <div className="space-y-4 md:space-y-6 translate-y-8">
                  <div className="aspect-[4/5] rounded-none overflow-hidden border border-gray-200 bg-gray-100">
                     <img src="/images/factory/制袋车间/10001.png" alt="Cleanroom Manufacturing" className="w-full h-full object-cover" />
                  </div>
                </div>
                <div className="space-y-4 md:space-y-6">
                  <div className="aspect-[4/5] rounded-none overflow-hidden border border-gray-200 bg-gray-100">
                     <img src="/images/factory/印刷车间/10002.png" alt="Quality Inspection" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            {CERTIFICATIONS.map((cert: (typeof CERTIFICATIONS)[number], index: number) => {
              ...
              >
                <div className="h-48 overflow-hidden relative">
                  <img src={cert.image} alt={cert.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-out" />
                </div>
                <div className="p-8">
