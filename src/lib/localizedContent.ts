...
const KNOWN_FALLBACK_TRANSLATIONS = {
  es: {
    ...
    "When selecting food packaging bags, consider the following factors: 1. Material safety (must be food-grade), 2. Barrier requirements (oxygen and moisture resistance), 3. Physical strength (puncture resistance), 4. Convenience (zippers, tear notches). At HLT PACK, we provide customized solutions based on your specific product needs.":
      "Al seleccionar bolsas para empaque de alimentos, considere los siguientes factores: 1. Seguridad del material (debe ser apto para alimentos), 2. Requisitos de barrera (resistencia al oxigeno y a la humedad), 3. Resistencia fisica (resistencia a perforaciones), 4. Comodidad (zippers y muescas de rasgado). En HLT PACK, ofrecemos soluciones personalizadas segun las necesidades especificas de su producto.",
    ...
    "Sustainable packaging helps reduce environmental impact and aligns with global green initiatives. HLT PACK offers a range of recyclable mono-material pouches and compostable films that deliver the same high-barrier performance as traditional plastics.":
      "El empaque sostenible ayuda a reducir el impacto ambiental y se alinea con las iniciativas verdes globales. HLT PACK ofrece una gama de bolsas monomaterial reciclables y peliculas compostables que proporcionan el mismo rendimiento de alta barrera que los plasticos tradicionales.",
    ...
    "At HLT PACK, we utilize advanced solvent-free laminators. This process uses 100% solid adhesives, curing quickly without releasing harmful emissions, making it the safest choice for food-contact packaging.":
      "En HLT PACK utilizamos laminadoras avanzadas sin solventes. Este proceso emplea adhesivos 100% solidos y cura rapidamente sin liberar emisiones nocivas, lo que lo convierte en la opcion mas segura para envases en contacto con alimentos.",
  ...
  ar: {
    ...
    "When selecting food packaging bags, consider the following factors: 1. Material safety (must be food-grade), 2. Barrier requirements (oxygen and moisture resistance), 3. Physical strength (puncture resistance), 4. Convenience (zippers, tear notches). At HLT PACK, we provide customized solutions based on your specific product needs.":
      "عند اختيار اكياس تغليف الطعام، ينبغي مراعاة العوامل التالية: 1. سلامة المادة ويجب ان تكون مخصصة للاغذية، 2. متطلبات الحاجز مثل مقاومة الاكسجين والرطوبة، 3. المتانة الفيزيائية مثل مقاومة الثقب، 4. سهولة الاستخدام مثل السحاب وفتحات التمزق. في HLT PACK نوفر حلولا مخصصة وفقا لاحتياجات منتجك المحددة.",
